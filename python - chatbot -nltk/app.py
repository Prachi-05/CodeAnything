...
def get_res(user_response):
    while 1:
        ...
        if (user_response == 'thanks' or user_response == 'thank you' or user_response == 'thanks chitti' or user_response == 'thank you chitti'):
            return str("Glad to help.")
        elif user_response == 'bye' or user_response == 'bye!' or user_response == 'bye chitti':
